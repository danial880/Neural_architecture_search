...
# parser.add_argument('--data', type=str, default='/data/msiddi01', help='location of the data corpus')
# parser.add_argument('--class_labels','--list', type=int, nargs='*',default=[0,1], help='num classes', required=False)
...
def get_desired_dataset(args):
  ...
  if args.dataset == 'DTD':
    ...
    train_data = torchvision.datasets.DTD(root='./data', train=True,
                                        download=True, transform=train_transform)
   
    test_data = torchvision.datasets.DTD(root='./data', train=False,
                                           download=True, transform=test_transform)
  ...
  if args.dataset == 'Food101':
    train_data = torchvision.datasets.Food101(root='./data', train=True,
                                        download=True, transform=train_transform)
 
    test_data = torchvision.datasets.Food101(root='./data', train=False,
                                           download=True, transform=test_transform)
  ...
  if args.dataset == 'flower102':
    ...
    train_data = torchvision.datasets.Flowers102(root='./data', train=True,
                                        download=True, transform=train_transform)
 
    test_data = torchvision.datasets.Flowers102(root='./data', train=False,
                                           download=True, transform=test_transform)
